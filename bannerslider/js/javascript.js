...
! function(i, h, m, e, d, k, f) {
    ...
    var u = i.$yboSlideshowFormations$ = new function() {
        var i = this,
            e = 0,
            a = 1,
            g = 2,
    ...
    i.$yboSlideshowRunner$ = function(n, q, o, r, w, v) {
        var a = this,
            f, m, i, t = 0,
    ...
    i.$yboThumbnailNavigator$ = function() {
        var i = this,
            E = b.V(i, p),
            h, B, a, y, C, m, l = [],
            A, z, g, n, r, w, v, x, t, u;
    ...
    n.yc = 21;
    n.Wb = 24;
    var t = i.$yboCaptionSlideo$ = function() {
            var a = this,
                db = b.V(a, p);
            l.call(a, 0, 0);
        ...
        j = i.$yboSlider$ = (i.module || {}).exports = function() {
            var a = this,
                Gc = b.V(a, p),
                Ob = "data-ybo-slider",
                ic = "data-ybo-thumb",
            ...
            function Oc(c) {
                ...
                if (u === a)
                    if (db) {
                        b.$StopEvent(c);
                        a = b.gb(e, f, "data-ybo-button", "A");
                        a && b.$CancelEvent(c)
                    } else {
                        t & 4 && (t = 0);
                        a = b.gb(e, f, "data-ybo-click");
                        if (a) {
                            b.$CancelEvent(c);
                            hitValues = (b.g(a, "data-ybo-click") || "").split(":");
